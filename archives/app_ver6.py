from utils import load_files, draw_base_map, draw_house_base_map, update_house_base_map, predict_house_xgb, draw_family_base_map
...
> *Leave blank if you do not have any preference in the list below.*
'''
        ...
        dcc.Tab(
            ...
            children = [
                ...
                html.Div([
                    ...
                    html.Div([
                        dcc.Graph(figure = draw_family_base_map(json_single_family, family_demo, family_dist))
                    ]),
...
def predict_house_price(neighbor, bed, bath, story, age, minarea, maxarea, minlot, maxlot, park, store, month, n_clicks):
    if n_clicks > 0:
        ...
        return [[
            ...
            ], json.dumps(predict_tab.to_dict('records'), indent = 2)]
