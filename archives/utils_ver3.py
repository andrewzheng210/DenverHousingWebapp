...
def load_files():
    ...
    return json_neighbor, neighbor_prices, json_neighbor_centers, single_family, neighbor_house_record, metrics, cities, city_data, family_dist, family_demo, city_seasonality
