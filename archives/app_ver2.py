...
city_data=pd.read_csv(r"CSVFiles/City Comparison.csv")
city_data["Region"]=city_data["Region"].str.strip()
city_seasonality=pd.read_csv(r"CSVFiles/City Seasonality.csv")
...
metrics=np.append(city_data.columns[3:],["Seasonality of Median Price","Seasonality of Home Sold"])
...
app.layout = html.Div([
    ...
    dcc.Tabs([
       ...
       dcc.Tab(
            ...
            children = [
                html.H2(
                    children='City-Level Comparison',
                    style={
                        'textAlign': 'center',
                        'color': '#1c5334',
                    }
                ...
                html.H3('Comparison between National, State and City Level'),
        ...
        html.H3('Comparison between Different Cities'),

        html.Div(
            className = 'three columns',
            children = [
                
                html.P('pick one or more cities'),
                html.Div(
                    dcc.Dropdown(
                    id="cities",
                    options=[
